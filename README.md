...
# Summary
Buckle up, Spartan. The sirens are wailing and the chase is on! In Hot Pursuit, one team plays as getaway drivers while the other suits up as the law, and it's pedal-to-the-metal mayhem through the streets of Reach. Weave through alleyways, launch off stunt ramps, and dodge rooftops as you outrun (or outgun) the competition in this high-octane custom Forge classic. No badges, no mercy - just tires screeching and Warthogs colliding in the ultimate game of cat and mouse.
With hundreds of community-crafted maps ranging from sprawling highways to tight urban gridlocks, no two chases ever play out the same. Forge veterans have gone all out creating large modded maps that use cosmic 330x scaling, and the custom-scripted gametype will pack squads of racers and pursuers alike into overstuffed vehicles using an extra seats mod. These features combined have created an experience that dwarfs anything you'll find in standard multiplayer (and it works on Xbox!).
# Map Files
